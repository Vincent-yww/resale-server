...
public class MyUtils {
    ...
    public static void sendMessageCodeByAliyun(String randomCode, String mobile) {
        try {
            ...
            request.putQueryParameter("SignName", "校园交易网");
            request.putQueryParameter("TemplateCode", "SMS_180055579");
    ...
    public static String uploadToQiniu(String filename){
...
//如果是Windows情况下，格式是 D:\\qiniu\\test.png
        if ("windows".equals(MyUtils.getOperateSysName())){
            filename="D:\\uploadFiles\\"+filename;
        }else{
            filename="/root/uploadfile/"+filename;
        }
