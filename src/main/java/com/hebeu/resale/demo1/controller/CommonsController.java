...
import com.hebeu.resale.demo1.utils.MyUtils;
...
public class CommonsController extends BaseController {
    ...
    public Map<String, Object> loadFiles(MultipartFile file, HttpServletRequest request) {
        ...
        try {
            ...
            String filename = MyUtils.uploadToQiniu(uploadSuccessFileName);
            return Json.success(filename, "文件上传成功！");
        } catch (Exception ex) {
            ex.printStackTrace();
    ...
    public Map<String, Object> downloadFileList(HttpServletRequest request) {
        ...
        try {
            filesNameList = (ArrayList<String>) MyUtils.getDownloadFileList(path);
